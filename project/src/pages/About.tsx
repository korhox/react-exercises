...
const About = () => (
    <>
        <div className="container mx-auto mt-8 mb-4 flex justify-between bg-white p-2">
        ...
        <div className="container mx-auto mt-20 flex bg-white p-2">
        ...
        <div className="container mx-auto mt-20 bg-white p-2 py-20">
